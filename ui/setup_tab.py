...
# Import from widgets module to avoid code duplication
from ui.widgets.multi_select import MultiSelectPopup, MultiSelectComboBox
...
class SetupTab(QWidget):
    ...
    def _scan_columns(self):
        ...
        if not sources:
            ...
            self.tax_config.set_tax_marked_columns([])
            return
